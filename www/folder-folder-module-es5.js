...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["folder-folder-module"], {
  ...
  function srcAppFolderFolderPageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _services_blogger_service__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(
    ...
    var FolderPage = /*#__PURE__*/function () {
      function FolderPage(bloggerService, router, loadingCtrl) {
      ...
      _createClass(FolderPage, [{
        ...
        value: function ngOnInit() {
          ...
          this.bloggerService.getBlogInfo().subscribe(function (data) {
            _this.siteInfo = data;
            console.log(_this.siteInfo);
          });
          this.bloggerService.getAllPosts().subscribe(function (res) {
            console.log(res);
              ...
              while (1) {
                switch (_context.prev = _context.next) {
                  ...
                  case 2:
                    ...
                    this.presentLoading(loading); //this.interstial();
        ...
        key: "getPostsBySearch",
        value: function getPostsBySearch() {
          var _this2 = this;

          var term = encodeURIComponent(this.searchTerm.trim());
          this.bloggerService.searchPosts(this.searchTerm).subscribe(function (res) {
